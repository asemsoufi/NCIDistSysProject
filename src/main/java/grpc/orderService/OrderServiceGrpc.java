...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.orderService.PlaceOrderRequest,
      grpc.orderService.PlaceOrderResponse> getPlaceOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "placeOrder",
      requestType = grpc.orderService.PlaceOrderRequest.class,
      responseType = grpc.orderService.PlaceOrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<grpc.orderService.PlaceOrderRequest,
      grpc.orderService.PlaceOrderResponse> getPlaceOrderMethod() {
    io.grpc.MethodDescriptor<grpc.orderService.PlaceOrderRequest, grpc.orderService.PlaceOrderResponse> getPlaceOrderMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getPlaceOrderMethod = OrderServiceGrpc.getPlaceOrderMethod) == null) {
          OrderServiceGrpc.getPlaceOrderMethod = getPlaceOrderMethod = 
              io.grpc.MethodDescriptor.<grpc.orderService.PlaceOrderRequest, grpc.orderService.PlaceOrderResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.orderService.PlaceOrderResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.orderService.GetAllOrdersRequest,
      grpc.orderService.GetOrderResponse> getGetAllOrdersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getAllOrders",
      requestType = grpc.orderService.GetAllOrdersRequest.class,
      responseType = grpc.orderService.GetOrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<grpc.orderService.GetAllOrdersRequest,
      grpc.orderService.GetOrderResponse> getGetAllOrdersMethod() {
    io.grpc.MethodDescriptor<grpc.orderService.GetAllOrdersRequest, grpc.orderService.GetOrderResponse> getGetAllOrdersMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getGetAllOrdersMethod = OrderServiceGrpc.getGetAllOrdersMethod) == null) {
          OrderServiceGrpc.getGetAllOrdersMethod = getGetAllOrdersMethod = 
              io.grpc.MethodDescriptor.<grpc.orderService.GetAllOrdersRequest, grpc.orderService.GetOrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "orderService.OrderService", "getAllOrders"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.orderService.GetAllOrdersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.orderService.GetOrderResponse.getDefaultInstance()))
  ...
  public static abstract class OrderServiceImplBase implements io.grpc.BindableService {
    ...
    public io.grpc.stub.StreamObserver<grpc.orderService.PlaceOrderRequest> placeOrder(
        io.grpc.stub.StreamObserver<grpc.orderService.PlaceOrderResponse> responseObserver) {
    ...
    /**
     */
    public void getAllOrders(grpc.orderService.GetAllOrdersRequest request,
        io.grpc.stub.StreamObserver<grpc.orderService.GetOrderResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                ...
                grpc.orderService.PlaceOrderResponse>(
          ...
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                grpc.orderService.GetAllOrdersRequest,
                grpc.orderService.GetOrderResponse>(
  ...
  public static final class OrderServiceBlockingStub extends io.grpc.stub.AbstractStub<OrderServiceBlockingStub> {
    ...
    /**
     */
    public grpc.orderService.GetOrderResponse getOrderDetails(grpc.orderService.GetOrderRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public java.util.Iterator<grpc.orderService.GetOrderResponse> getAllOrders(
        grpc.orderService.GetAllOrdersRequest request) {
  ...
  public static final class OrderServiceFutureStub extends io.grpc.stub.AbstractStub<OrderServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.orderService.GetOrderResponse> getOrderDetails(
        grpc.orderService.GetOrderRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getGetOrderDetailsMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_GET_ALL_ORDERS = 3;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_ALL_ORDERS:
          serviceImpl.getAllOrders((grpc.orderService.GetAllOrdersRequest) request,
              (io.grpc.stub.StreamObserver<grpc.orderService.GetOrderResponse>) responseObserver);
          break;
        default:
